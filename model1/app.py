...
df = load_data('data_for_lstm_model1.csv')
scaler = load_scaler('minmax_scaler0.pkl')
model = load_keras_model('best_attention_model.keras')
lookbacks = 4
rolling_size = 7
...
if st.button('Start Prediction'):
    try:
        ...
        if days_into_future > 0:
            ...
            fig, ax = plt.subplots()
            ax.plot(last_100.index, last_100['modal_price (Rs./Quitnal)'], label='Historical Data')
